...
const DEFAULT_GOOGLE_SHEETS_WEBHOOK_URL = "https://script.google.com/macros/s/AKfycbwN9jOvWNJ7w_tY1zrDlGYKAwiZ-uU0GLqdb3P48ztv1rP-IKVavTWjQrynawdyCLHP/exec";
const DEFAULT_GOOGLE_SHEETS_WEBHOOK_SECRET = "ss-planilha-2026";
const GOOGLE_SHEETS_WEBHOOK_URL = process.env.GOOGLE_SHEETS_WEBHOOK_URL || DEFAULT_GOOGLE_SHEETS_WEBHOOK_URL;
const GOOGLE_SHEETS_WEBHOOK_SECRET = process.env.GOOGLE_SHEETS_WEBHOOK_SECRET || DEFAULT_GOOGLE_SHEETS_WEBHOOK_SECRET;
